...
public final class Condition__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7243e6ac03d84eb4L, 0x9ecc7a6ffc7a53d2L, 0x520310003ee1f8cdL, "GameRuleLanguage.structure.Condition");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isExactly(SNodeOperations.asSConcept(kind), CONCEPTS.MethodDeclaration$93)) {
      Iterable<SNode> methods = SNodeOperations.ofConcept(Sequence.fromIterable(IClassifierType__BehaviorDescriptor.getMembers_id6r77ob2V1Fr.invoke(Classifier__BehaviorDescriptor.getThisType_id2RtWPFZ12w7.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.patternType$ZGZ_)))).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return SNodeOperations.isInstanceOf(it, CONCEPTS.InstanceMethodDeclaration$An);
        }
      }), CONCEPTS.MethodDeclaration$93);
      return Scopes.forMethods(kind, new MethodsScope(Classifier__BehaviorDescriptor.getThisType_id2RtWPFZ12w7.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.patternType$ZGZ_)), methods), ScopeUtils.lazyParentScope(__thisNode__, kind));
